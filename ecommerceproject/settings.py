...
SECRET_KEY = 'django-insecure-d$xxo@7wrq3g&@r#7u+)5*b%$naeliw#f=lwlobab$(u@axu22'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'ecommerceproject' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_HOST_PASSWORD = 'nblz qgay mlsn geql'
EMAIL_USE_TLS = True
